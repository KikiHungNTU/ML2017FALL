...
#
for row in range(len(test_x)):
#    test_X[row] = test_x[row][np.r_[18:27,45:54,54:63,63:72,72:81,81:90,108:117]]
#    test_SquareTerm[row] = test_x[row][np.r_[72:81,99:108,117:126]]
#     test_X[row] = test_x[row][np.r_[18:27,27:36,45:54,63:72,72:81,81:90,108:117]]
#        #只選PM2.5
     test_X[row] = test_x[row][np.r_[72:81,81:90]]
##     test_X[row] = test_x[row][np.r_[18:27,45:54,63:72,72:81,81:90,108:117]] 
##     test_SquareTerm[row] = test_x[row][np.r_[18:27,45:54,63:72,72:81,81:90,108:117]] 
#
#
test_x = np.array(test_X)
